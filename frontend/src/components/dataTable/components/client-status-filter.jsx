...
export function ClientFilter({ table }) {
  ...
  const handleSelect = (value) => {
    setSelectedValues((prev) => {
      ...
      selectedColumn?.setFilterValue(newSelectedValues.length > 0 ? newSelectedValues : undefined);
  ...
  return (
    <div className="flex items-center">
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent align="start" className="w-36 p-0" sideOffset={4}>
          <Command>
            <CommandList>
              ...
              {selectedValues.length > 0 && (
                <>
                  <Separator />
                  <CommandItem onSelect={clearFilters} className="justify-center">
                    Clear filters
                  </CommandItem>
                </>
              )}
