	...
	'inline-flex items-center rounded-full border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300',
	{
		variants: {
			variant: {
				...
				'outline-blue': 'text-secondary border-secondary bg-secondary-background',
				'outline-success':
					'text-paid border-paid bg-paid-background',
				'outline-destructive': 'text-destructive border-destructive bg-destructive-background',
				'outline-yellow': 'text-partial border-partial bg-partial-background',
			},
		},
		defaultVariants: {
			variant: 'default',
