		...
		<div>
			<Card>
				...
				<CardContent className="space-y-4">
					...
					<div className="text-sm text-gray-500">Grand Total / Remaining Balance</div>
				...
				<CardFooter className="flex justify-between">
					...
					Last Transaction Date: {selectedClient?.lastTransactionDate 
						? new Date(selectedClient.lastTransactionDate).toLocaleDateString("en-US", { year: 'numeric', month: 'long', day: 'numeric' }) 
						: "No transactions"}
					</div>
					<Badge
						variant={
